...
//   * RouteStep.description — human-readable summary across the
//     maneuver / modifier combinations we care about.
...
void main() {
  ...
  group('RouteStep.description', () {
    test('turn + street name produces "Turn left onto Kenyatta Road"', () {
      ...
      expect(step.description, 'Turn left onto Kenyatta Road');
    });
    ...
    test('continue without modifier falls back to "Continue on <name>"', () {
      ...
      expect(step.description, 'Continue on Creek Road');
    });
    ...
    test('modifier-only (no street) renders the modifier alone', () {
      ...
      expect(step.description, 'Turn right');
    });
    ...
    test('arrive step is labelled explicitly', () {
      ...
      expect(step.description, 'Arrive at destination');
    });
  });
