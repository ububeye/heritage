...
class LanguageCubit extends Cubit<LanguageState> {
  ...
  Future<void> loadLanguage() async {
    ...
    emit(state.copyWith(uiLanguage: uiLanguage, audioLanguage: audioLanguage));
  }
...
class LanguageState {
  const LanguageState({this.uiLanguage = 'en', this.audioLanguage = 'en'});
  final String uiLanguage;
  final String audioLanguage;

  LanguageState copyWith({String? uiLanguage, String? audioLanguage}) {
